...
import ConfigComponent, { _ as _export_sfc } from './__federation_expose_Config-qY6OUsJf.js';
    ...
    _createVNode$2h(_component_v_app, null, {
      default: _withCtx(() => [
                ...
                _createVNode$2h(_component_v_window, {
                  ...
                  default: _withCtx(() => [
                    _createVNode$2h(_component_v_window_item, { value: "config" }, {
                      default: _withCtx(() => [
                        _cache[6] || (_cache[6] = _createElementVNode("h2", { class: "text-h5 mb-4" }, "Config组件", -1 /* HOISTED */)),
        ...
        _createVNode$2h(_component_v_footer, {
          ...
          default: _withCtx(() => [
            _createElementVNode("span", _hoisted_3, "下载任务分类与标签魔改VUE版 ©" + _toDisplayString(new Date().getFullYear()), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        })
      ]),
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-7a7a37b1"],['__file',"C:/Users/joe/IdeaProjects/MoviePilot-Plugins/plugins.v3/downloadsitetagmodnew/src/App.vue"]]);
