                        ...
                        _createVNode(_component_v_col, { cols: "12" }, {
                          default: _withCtx(() => [
                            _createVNode(_component_v_text_field, {
                              ...
                              "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((config.custom_api_url) = $event)),
                              label: "自定义API地址",
                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_text_field, {
                          ...
                          "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((config.bot_token) = $event)),
                          label: "Bot Token",
                    ...
                    _createVNode(_component_v_col, { cols: "12" }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_textarea, {
                          ...
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.whitelist) = $event)),
                          label: "白名单用户ID",
